...
shifty.config.tags = {
  ["tmp_l"]    = { init = true, position = 1, screen = 1, layout = awful.layout.suit.fair                     },
  ["tmp_r"]    = { init = true, position = 1, screen = 2, layout = awful.layout.suit.fair                     },
  ["dev"]    = { init = true, position = 1, screen = 2, layout = awful.layout.suit.fair                     },
  ["web"]     = { position = 2, screen = 2, layout = awful.layout.suit.fair, mwfact = 0.6, spawn = browser, max_clients = 2  },
  ...
  ["wine"]    = { position = 7, screen = 2, layout = awful.layout.suit.max.fullscreen, exclusive = true                        },
  ["office"]    = { position = 9, screen = 2, layout = awful.layout.suit.tile.bottom, max_clients = 1                        },
  ["read"]    = { position = 8, screen = 2, layout = awful.layout.suit.fullscreen, max_clients = 1                       },
  ["irc"]     = { position = 0, screen = 1, layout = awful.layout.suit.fullscreen, max_clients = 1                       },
  ["ff"]     = { position = 0, screen = 1, layout = awful.layout.suit.fullscreen, max_clients = 1                       },
}

--shifty: tags matching and client rules
shifty.config.apps = {
  { match = { "luakit", "Chromium", "Opera"     }, tag = "web", float = false,                             },
  { match = {  "Firefox"     }, tag = "ff", float = false,                             },
  { match = { "Pidgin"                     }, tag = "im",                                     },
  { match = { "Wine"                       }, tag = "wine",                                   },
  { match = {  "Skype"                     }, tag = "im",                                    },
